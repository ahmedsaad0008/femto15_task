...
Route::resource('user', 'UserController')->except(['show', 'create', 'store'])->middleware('admin:admin');
Route::post('user/{id}/activate', 'UserController@activate')->name('user.activate')->middleware('admin:admin');
Route::get('user/chart/show', 'UserController@chart')->name('user.chart')->middleware('admin:admin');
Route::post('user/{id}/deactivate', 'UserController@deactivate')->name('user.deactivate')->middleware('admin:admin');
